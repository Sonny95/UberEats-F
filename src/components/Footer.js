  ...
  return (
    <div className='ml-8 mr-8'>
        <div className='w-1/2 h-5/6 inline-block float-left'>
            <Logo />
            <div className='mt-56'>
            <img src='https://d3i4yxtzktqr9n.cloudfront.net/web-eats-v2/783bb4a82e5be29e.svg' alt="AppStore"
            className='w-36 h-12 inline-block mr-4' />
            <img src='https://d3i4yxtzktqr9n.cloudfront.net/web-eats-v2/163bdc9b0f1e7c9e.png' alt="googlePlayStore"
            className='w-36 h-12 inline-block'/>
            </div>
        </div>
