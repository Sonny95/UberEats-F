    ...
    <div>
      ...
      <div className="absolute top-0  right-8 mt-8 ml-8 flex items-center">
        <Link href="/emailCheck">
          <button src={burger} className="inline-block w-28 h-12 mr-4 bg-white font-semibold rounded-full" alt="Burger Icon">
            Log In
          </button>
        </Link>
        <Link href="/emailCheck">
          <button src={burger} className="inline-block w-28 h-12 mr-4 bg-black text-white font-semibold rounded-full" alt="Burger Icon">
            Sign Up
          </button>
        </Link>
      </div>
